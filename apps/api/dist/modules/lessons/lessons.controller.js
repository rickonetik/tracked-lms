...
const student_lesson_dto_1 = require("./dto/student-lesson.dto");
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ type: student_lesson_dto_1.StudentLessonDto, description: 'Данные урока' }),
