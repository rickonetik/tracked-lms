# Version 0.0.1 — Foundation (repo/infra/dev-опыт)
...
Version 0.0.1 — Foundation (repo/infra/dev-опыт). Завершены все stories из Epic 0, проект готов к разработке функционала.
